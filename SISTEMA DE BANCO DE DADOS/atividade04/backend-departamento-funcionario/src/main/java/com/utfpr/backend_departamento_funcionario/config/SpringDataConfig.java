...
package com.utfpr.backend_departamento_funcionario.config;
...
@Configuration
@EnableJpaRepositories("com.utfpr.backend_departamento_funcionario.repository")
...
public class SpringDataConfig {
    ...
    public DataSource dataSource() {
        ...
        try {
            ...
            ds.setJdbcUrl("jdbc:mariadb://localhost:3307/atividade04");  // Substitua "nome_do_banco" pelo nome do seu banco
            ds.setUsername("root");  // Altere para seu usuário do MariaDB
            ds.setPassword("admin");  // Altere para a senha do seu usuário
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.utfpr.backend_departamento_funcionario.entity");
        return factory;
